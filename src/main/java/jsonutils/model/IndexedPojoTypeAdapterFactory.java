...
public class IndexedPojoTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        ...
        if (!IndexedPojo.class.isAssignableFrom(typeToken.getRawType())) {
            return null;
        }
        ...
        TypeAdapter<IndexedPojo> delegate = (TypeAdapter<IndexedPojo>) gson.getDelegateAdapter(this, typeToken);
